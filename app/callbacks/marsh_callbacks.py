                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            html.Div(
                                        ...
                                        children = [
                                            html.Img(src='/assets/logos/warning.png', style={'width':'32px','height':'32px'}), html.Span(" Be patient! The computation may take several minutes!", className="form-check-label")
                                        ]
                                    ),
